...
namespace AnimeReviewAPI.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        [ProducesResponseType(200, Type = typeof(Review))]
        [ProducesResponseType(400)]
        public IActionResult GetReviewsForAnAnime(int animeId)
        {
            var reviews = _mapper.Map<List<ReviewDto>>(_reviewRepository.GetReviewsOfAnAnime(animeId));
        ...
        [ProducesResponseType(400)]
        public IActionResult CreateReview([FromQuery] int reviewerId, [FromQuery]int aniId, [FromBody] ReviewDto reviewCreate)
        {
            ...
            reviewMap.Anime = _animeRepository.GetAnimeById(aniId);
